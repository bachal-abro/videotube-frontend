...
export function VideoCard({
  ...
  return (
    <div className={cn("group cursor-pointer", className)} onClick={handleClick}>
      <div
      ...
      <div className="flex gap-3">
        ...
        <div className="relative group-hover:scale-105 transition-transform duration-300">
          <Avatar className="h-9 w-9 rounded-full flex-shrink-0 border-2 border-transparent group-hover:border-primary/20 transition-all">
            ...
            />
            <AvatarFallback className="bg-primary/10 text-primary font-medium">{channelName.charAt(0)}</AvatarFallback>
          </Avatar>
        </div>
